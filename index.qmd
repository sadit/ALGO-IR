...
- El [Cap. 6 — Intersecciones](cap6-intersecciones.qmd) estudia algoritmos de intersección de conjuntos, los cuales son la base de sistemas de información capaces de manipular cantidades enormes de datos.
- Finalmente, el [Cap. 7 — Cadenas de texto](cap7-cadenas.qmd) estudia algoritmos de búsqueda de patrones en cadenas de símbolos, basados en autómatas finitos.
